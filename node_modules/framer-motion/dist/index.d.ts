...
declare function createScopedAnimate(scope?: AnimationScope): {
    ...
    <V extends string | number>(value: V | MotionValue<V>, keyframes: V | GenericKeyframesTarget<V>, options?: ValueAnimationTransition<V>): AnimationPlaybackControls;
...
declare function useAnimate<T extends Element = any>(): [AnimationScope<T>, {
    ...
    <V extends string | number>(value: V | MotionValue<V>, keyframes: V | GenericKeyframesTarget<V>, options?: ValueAnimationTransition<V> | undefined): AnimationPlaybackControls;
