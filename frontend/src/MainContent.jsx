...
const MainContent = () => {
  ...
  const hideNavbar =
    hideNavbarRoutes.includes(normalizedPath) ||
    normalizedPath.startsWith(agroShopRoute);
            ...
            <div>
              ...
              <Routes>
                ...
                <Route
                  ...
                  element={<CropRotationRecommendation />}
                />
                ...
                <Route
                  path='/soiltestingcentres'
                  element={<SoilTestingCentres />}
                />
                <Route path='/CropCalender' element={<CropCalender />} />
                <Route path='/TaskReminder' element={<TaskReminder />} />
                <Route
                  path='/SugarcaneRecognition'
                  element={<SugarcaneRecognition />}
                />
                <Route
                  path='/PaddyRecognition'
                  element={<PaddyRecognition />}
                />
                <Route
                ...
                />
                <Route
                  path='/PlantTaskReminder'
                  element={<PlantTaskReminder />}
                />
                <Route
                  path='/CropManagementGuide'
                  element={<CropManagementGuide />}
                />
                <Route path='/EcoCropManager' element={<EcoCropManager />} />
                <Route
                  path='/FertilizerCalculator'
                  element={<FertilizerCalculator />}
                />
                <Route path='/Climate' element={<Climate />} />
                <Route
                  path='/FertilizerRequirementsCalculator'
                  element={<FertilizerRequirementsCalculator />}
                />
                <Route
                  path='/SoilMoistureCalculator'
                  element={<SoilMoistureCalculator />}
                />
                <Route
                  path='/WaterRequirementCalculator'
                  element={<WaterRequirementCalculator />}
                />
                <Route
                  path='/CropYieldCalculator'
                  element={<CropYieldCalculator />}
                />
                <Route
                  path='/MushroomEdibility'
                  element={<MushroomEdibility />}
                />
                <Route path='/products' element={<Products />} />
                <Route path='/Auth-page' element={<AuthPage />} />
                <Route path='/whyai' element={<WhyAI />} />{" "}
                {/* Add the route for Why AI */}
