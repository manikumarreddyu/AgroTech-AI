      ...
      <div className="w-full text-[#000435] bg-white dark:text-white dark:bg-green-500 py-16 px-4" style={{ backgroundImage: `url(${bgHero})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
          <div className="flex flex-col justify-center">
            ...
            <p className="text-lg text-[#000435] bg-white dark:text-white dark:bg-green-500 font-semibold">
            ...
            <Link
              to="/app/posts"
              className='text-[#000435] bg-white dark:text-white dark:bg-green-500 mt-9'>
