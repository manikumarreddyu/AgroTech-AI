    ...
    <div className="w-full text-[#000435] bg-white dark:text-white dark:bg-green-400 py-16 px-4" style={{ backgroundImage: `url(${bgHero})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-lg text-[#000435] bg-white dark:text-white dark:bg-green-400 text-justify">
            🌱 Our mission is to provide advanced AI tools to farmers, helping them optimize their agricultural practices.
          </p>
          <p className='md:text-3xl sm:text-3xl text-2xl font-bold py-4 text-[#000435] bg-white dark:text-white dark:bg-green-400'>
            🤔 How it Works!
          </p>
          <p className="text-lg text-[#000435] bg-white dark:text-white dark:bg-green-400">
