          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:space-x-4">
            ...
            <div className="relative">
              ...
              {openDropdown === "tools" && (
                <div className="absolute left-0 mt-2 w-60 bg-white text-black rounded-lg shadow-lg z-50">
                  <NavLink
                    to="/FertilizerRequirementsCalculator"
                    className="block py-2 px-4 hover:bg-gray-200"
                    onClick={closeMenu}
                  >
                  ...
                  <NavLink
                    to="/FertilizerCalculator"
                    className="block py-2 px-4 hover:bg-gray-200"
                    onClick={closeMenu}
                  >
                    Fertilizer Calculator Advanced
                  </NavLink>
                </div>
              )}
            </div>
            ...
            <div className="relative">
              ...
              >
                ...
                <FaChevronDown
                  className={`ml-1 transition-transform duration-200 ${
                    openDropdown === "help" ? "transform rotate-180" : ""
                  }`}
                />
              </button>
              {openDropdown === "help" && (
